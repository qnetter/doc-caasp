...
* SUSE CaaS Platform 3 was based on SLE 12 SP3, while version 4.0 is based on SLE 15.
...
* Updated Kubernetes version: Version 3 shipped 1.10 via the updates channel. Version 4.0 ships with Kubernetes 1.13
...
* Tech preview: Cilium SDN. Cilium is allowing CaaS Platform users to take advantage of Kubernetes Network Policies. Flannel is still fully supported as part of version 4.0.
...
* No mirror configuration for Airgap for version 4.0 (https://bugzilla.suse.com/show_bug.cgi?id=1125018)
