...
You can log the following groups of services. See the <<_centralized-logging-deployment>>
...
[[_centralized-logging-deployment]]
== Deployment
...
See <<_centralized-logging-optional-settings>> for the facultative parameters and their default values.
...
[[_centralized-logging-optional-settings]]
== Optional settings
